    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            */
            ...
            // Recogemos el objeto usuario que devuelve la función
            Usuario userAutenticado = verifyUser(u);
            
            if (userAutenticado != null) {
//                misesion = request.getSession();
                misesion.setAttribute("user", userAutenticado);
...
//            out.println("</form>");             
     ...
     */
    private Usuario verifyUser(Usuario u) {
