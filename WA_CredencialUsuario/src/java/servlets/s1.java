...
public class s1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // Creamos un objeto Usuario para realizar la comprobación.
            Usuario u = new Usuario();
            
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>WA - Credencial Usuario (Servlet s1)</title>");
            out.println("<style>p {font-size: 1.5em;}</style>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Comprobación Credenciales - Resultado</h1>");
            
            if (user.equals(u.getUsuario()) && pwd.equals(u.getPassword())) {
